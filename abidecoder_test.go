...
func TestABI_Read(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "public_key", typeName: "public_key", data: ecc.MustNewPublicKey(ecc.PublicKeyPrefixK1Output + "1111111111111111111111111111111114T1Anm"), expectedValue: s(`"` + "PUB_K1_" + `1111111111111111111111111111111114T1Anm"`)},
		{name: "public_key_k1", typeName: "public_key", data: ecc.MustNewPublicKey("PUB_K1_1111111111111111111111111111111114T1Anm"), expectedValue: s(`"` + "PUB_K1_" + `1111111111111111111111111111111114T1Anm"`)},
