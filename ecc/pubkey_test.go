...
func Test_PublicKeyMarshalUnmarshal(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			expectedKey: PublicKeyPrefixK1Output + "6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
		},
		{
			name:        "K1",
		...
		{
			name:        "GM",
			key:         "PUB_GM_7gyUV7Q8YF59EAsWgoQcYKdrYy5NEGFhCzx5pdJFtd7rURgaic",
			expectedKey: "PUB_GM_7gyUV7Q8YF59EAsWgoQcYKdrYy5NEGFhCzx5pdJFtd7rURgaic",
		},
	}
...
func TestPublicKey_MarshalJSON(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			name:         "K1-EOS",
			key:          PublicKeyPrefixCompat + "6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
			expectedJSON: `"` + PublicKeyPrefixK1Output + `6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV"`,
		},
		{
			name:         "K1",
			key:          "PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
		...
		},
		{
			name:         "GM",
			key:          "PUB_GM_7gyUV7Q8YF59EAsWgoQcYKdrYy5NEGFhCzx5pdJFtd7rURgaic",
			expectedJSON: `"PUB_GM_7gyUV7Q8YF59EAsWgoQcYKdrYy5NEGFhCzx5pdJFtd7rURgaic"`,
		},
	}
